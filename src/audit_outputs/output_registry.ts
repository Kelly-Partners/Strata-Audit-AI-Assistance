  ...
  "expense_samples": [
    {
      ...
      "Three_Way_Match": {
        ...
        "payment": { "status": "PAID|ACCRUED|MISSING|BANK_STMT_MISSING", "bank_date": "String", "amount_match": Boolean, "source_doc": "String", "creditors_ref": "String", "checks": { "bank_account_match": { "passed": Boolean, "evidence": { "source_doc_id", "page_ref", "note" } }, "payee_match": { "passed", "evidence" }, "duplicate_check": { "passed", "evidence" }, "split_payment_check": { "passed", "evidence" }, "amount_match": { "passed", "evidence" }, "date_match": { "passed", "evidence" } }, "evidence": { "source_doc_id": "String", "page_ref": "String", "note": "String", "extracted_amount": Number } },
